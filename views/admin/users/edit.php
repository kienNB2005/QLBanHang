...
<body>
  ...
  <div class="sidebar">
    ...
    <a href="/QLBanHang/admin.php?page=category&action=index" class="active"><i class="fa fa-book"></i> Quản lý Truyện</a>
  ...
  <div class="content">
    ...
    <form method="POST" action="/QLBanHang/admin.php?page=user&action=edit">
      <input type="hidden" name="id" value="<?= $data['id'] ?>">
      <div>
        <label for="name">Họ tên</label>
        <input type="text" name="fullname" value="<?= htmlspecialchars($data['full_name']) ?>" required>
      </div>
      <div>
        <label for="name">Tên đăng nhập</label>
        <input type="text" name="username" value="<?= htmlspecialchars($data['user_name']) ?>" required>
      </div>
      <div>
        <label for="name">Mật khẩu</label>
        <input type="text" name="pass" value="<?= htmlspecialchars($data['password']) ?>" required>
      </div>
      <div>
      ...
      <div class="btn-group" role="group" aria-label="Giới tính">
        ...
        <input type="radio" class="btn-check" name="gender" id="male" value="Nam" 
      ...
      <option value="3" <?= $data['role_id'] == 3 ? 'selected' : '' ?>>User</option>
      </select>
      </div>
