...
<body>
  ...
  <div class="content">
    ...
    <!-- Nút thêm mới -->
    <div class="mb-3">
      <a href="/QLBanHang/admin.php?page=product&action=displayInfo">
            ...
            <?php if (!empty($datas)): ?>
                <?php foreach ($datas as $data): ?>
                    <tr>
                        ...
                        <td>
                            <a href="/QLBanHang/admin.php?page=product&action=edit&id=<?= $data['id'] ?>" 
                              class="btn btn-sm btn-warning">Sửa</a>

                            <form method="POST" action="/QLBanHang/admin.php?page=product&action=delete" style="display:inline;">
